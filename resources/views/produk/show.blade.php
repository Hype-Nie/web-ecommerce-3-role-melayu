...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="grid lg:grid-cols-2 gap-10 lg:gap-16">
        ...
        <div class="animate-fade-in">
            <div class="aspect-square rounded-3xl bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center">
        ...
        <div class="animate-fade-in-right">
            ...
            {{-- Cart Actions --}}
            @auth
            <form action="{{ route('cart.add') }}" method="POST" class="flex gap-3 mb-6">@csrf
                ...
                <button type="submit" class="btn-primary flex-1 text-center flex items-center justify-center gap-2" {{ $product->stock <= 0 ? 'disabled' : '' }}>
