...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 p-4 mb-8 animate-fade-in">
        <form action="{{ route('produk.index') }}" method="GET" class="relative mb-6">
            ...
            <input type="text" id="main-search-input" name="search" value="{{ request('search') }}" placeholder="Cari produk di sini..." class="w-full pl-11 pr-4 py-3 rounded-[28px] border border-gray-200 bg-gray-50 text-sm outline-none focus:border-black focus:bg-white transition-colors">
